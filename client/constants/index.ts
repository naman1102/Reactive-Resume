...
export const DONATION_URL = 'https://paypal.me/naman';
export const TRANSLATE_URL = 'https://translate.rxresu.me/';
export const GITHUB_URL = 'https://github.com/naman1102/Reactive-Resume';
export const PRODUCT_HUNT_URL = 'https://www.producthunt.com/posts/reactive-resume-v3';
export const GITHUB_ISSUES_URL = 'https://github.com/naman1102/Reactive-Resume/issues/new/choose';
