  ...
  <div className="prose mx-auto my-12 dark:prose-invert">
    ...
    <p>
      <s>
        ...
        to it, still belong to Naman Mehta.
      </s>
    </p>
    ...
    <p>
      Naman Mehta is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
    ...
    <p>
      You should be aware that there are certain things that Naman Mehta will not take responsibility for. Certain
      functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or
      provided by your mobile network provider, but Naman Mehta cannot take responsibility for the app not working at
    ...
    <p>
      Along the same lines, Naman Mehta cannot always take responsibility for the way you use the app i.e. You need to
      make sure that your device stays charged – if it runs out of battery and you can&apos;t turn it on to avail the
      Service, Naman Mehta cannot accept responsibility.
    </p>

    <p>
      With respect to Naman Mehta&apos;s responsibility for your use of the app, when you&apos;re using the app,
      it&apos;s important to bear in mind that although we endeavor to ensure that it is updated and correct at all
      times, we do rely on third parties to provide information to us so that we can make it available to you. Naman Mehta 
    ...
    <p>
      ...
      you&apos;ll need to download the updates if you want to keep using the app. Naman Mehta does not promise that it
